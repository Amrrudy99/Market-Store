								...
								foreach($cats as $cat){
									echo "<div class='cat'>";
										echo "<div class='hidden-buttons'>";
											...
											echo "<a href='categories.php?do=Delete&catid=" .$cat['ID']. "' class='confirm btn btn-xs btn-danger'><i class='fa fa-trash'></i> Delete</a>";
										echo "</div>";
										echo "<h3>" .  $cat['Name'] . '</h3>';
										echo "<div class='full-view'>";
											echo "<p>"; if($cat['Description'] == '') {echo 'This Category has no Description';}  else { echo $cat['Description']; } echo "</p>";
											if($cat['Visibility'] == 1 ){ echo '<span class="visibility"><i class="fa fa-eye"></i> Hidden</span>'; }
											if($cat['Allow_Comment'] == 1 ){ echo '<span class="commenting"><i class="fa fa-times"></i> Comment Disable</span>'; }
											if($cat['Allow_Ads'] == 1 ){ echo '<span class="advertises"><i class="fa fa-times"></i> ADS Disable</span>'; }
										echo "</div>";
